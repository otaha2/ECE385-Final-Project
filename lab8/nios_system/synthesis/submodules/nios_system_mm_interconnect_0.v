...
module nios_system_mm_interconnect_0 (
	...
	wire  [105:0] accum_s1_agent_rf_source_data;                                                      // Accum_s1_agent:rf_source_data -> Accum_s1_agent_rsp_fifo:in_data
	...
	wire  [105:0] accum_s1_agent_rsp_fifo_out_data;                                                   // Accum_s1_agent_rsp_fifo:out_data -> Accum_s1_agent:rf_sink_data
	...
	wire  [104:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> Accum_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // Accum_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> Accum_s1_agent:cp_channel
	...
	wire  [104:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> Reset_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // Reset_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> Reset_s1_agent:cp_channel
	...
	wire  [104:0] accum_s1_agent_rp_data;                                                             // Accum_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [104:0] reset_s1_agent_rp_data;                                                             // Reset_s1_agent:rp_data -> router_009:sink_data
